...
exports.create = async (request, response) => {
    ...
    try {
        var savedata = await new materialmodel(data).save()
            .then((result) => {
                const data = {
                    _status: true,
...
exports.view = async (request, response) => {
  try {
    ...
    const total_records = await materialmodel.countDocuments(filter);
...
try {
    ...
    data.updated_at = Date.now();
        ...
        var savedata =  await materialmodel.updateOne({ _id: request.params.id }, { $set: data }, ) 
            .then((result) => {
...
exports.destroy = async(request, response) => {
    ...
    var data ={
        ...
        var savedata =  await materialmodel.updateMany({ _id: request.body.ids }, { $set: data }, ) 
            .then((result) => {
                if (result) {
                const data = {
                    _status: true,
