...
export default function ViewCategory() {
  ...
  useEffect(() => {
    axios.post(`${import.meta.env.VITE_BASE_URL}${import.meta.env.VITE_SUB_CATEGORIES_URL}/view`, {
      limit: 10,
      page: currentPage,
      name: searchname,
  ...
  const changestatus = () => {
    axios.post(`${import.meta.env.VITE_BASE_URL}${import.meta.env.VITE_SUB_CATEGORIES_URL}/change-status`, {
      ids: checkboxvalue
    })
      .then((result) => {
        if (result.data._status == true) {
  ...
  const deleterecord = () => {
    axios.put(`${import.meta.env.VITE_BASE_URL}${import.meta.env.VITE_SUB_CATEGORIES_URL}/delete`, {
      ids: checkboxvalue
    })
      .then((result) => {
        if (result.data._status == true) {
        ...
        <form autoComplete='off' className="grid grid-cols-[40%_35%_5%] gap-[1%] items-center ">
          <div className="">
            ...
            <select
              ...
              onKeyUp={filterbyparentcategory}
                      ...
                      <th scope="col" class="p-4">
                        <div class="flex items-center">
                          <input id="checkbox-all-search"
                            onClick={allcheckbox}
                            checked={checkboxvalue.length == subcategories.length ? 'checked' : ''}
