                ...
                <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        ...
                        <div className="px-4 py-3 w-72">
                            <span className="text-gray-400 mr-3 uppercase text-xs">Brand: {data.brand_name ? data.brand_name:'N/A' }</span>
                            <span className="text-gray-400 mr-3 uppercase text-xs">category: {data.category_name}</span>
                            
                            <div className="flex items-center">
                                <p className="text-lg font-semibold text-black cursor-auto my-3">{data.name}</p>
                                <del>
