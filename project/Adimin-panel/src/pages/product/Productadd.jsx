        ...
        <ol className="p-3 px-6 inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div className="flex items-center">
              /
              <a className="ms-1 text-md font-medium text-gray-700 hover:text-blue-600 md:ms-2">Product</a>
            </div>
          </li>
      ...
      <div className='w-full px-6 py-6  '>
        ...
        <form >
            ...
            <div className="for-images ">
              ...
              <div className="">
                <label
                  ...
                  className="block  text-md font-medium text-gray-900 text-[#76838f] ml-5"
                >
                  Product Image
                </label>
                <input
          ...
          <div className='py-[40px]'>
            ...
            {/* <ReactQuill theme="snow"  className='h-[200px]'/> 
              */}
